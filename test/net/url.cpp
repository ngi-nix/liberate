...
{
  // With everything
  auto url = net::url::parse("https://finkhaeuser.de/path/to?some=value&simple&other=tRue#myfrag");
...
TEST(URL, authority_path_and_fragment)
{
  ...
  auto url = net::url::parse("https://finkhaeuser.de/path/to/#myfrag");
  ASSERT_EQ(std::string("https"), url.scheme);
  ASSERT_EQ(std::string("finkhaeuser.de"), url.authority);
  ASSERT_EQ(std::string("/path/to/"), url.path);
  ...
  url = net::url::parse("https://finkhaeuser.de/path/to?some=value&simple&other=tRue");
  ASSERT_EQ(std::string("https"), url.scheme);
  ASSERT_EQ(std::string("finkhaeuser.de"), url.authority);
  ASSERT_EQ(std::string("/path/to"), url.path);
  ASSERT_EQ(3, url.query.size());
...
{
  // With query, no fragment
  auto url = net::url::parse("https://finkhaeuser.de/path/to?some=value&simple&other=tRue");
  ASSERT_EQ(std::string("https"), url.scheme);
  ASSERT_EQ(std::string("finkhaeuser.de"), url.authority);
  ASSERT_EQ(std::string("/path/to"), url.path);
  ASSERT_EQ(3, url.query.size());
...
TEST(URL, authority_query_and_fragment)
{
  ...
  auto url = net::url::parse("https://finkhaeuser.de?some=value&simple&other=tRue#myfrag");
  ASSERT_EQ(std::string("https"), url.scheme);
  ASSERT_EQ(std::string("finkhaeuser.de"), url.authority);
...
TEST(URL, path_and_fragment)
{
  ...
  auto url = net::url::parse("file:///path/to?some=value&simple&other=tRue#myfrag");
...
TEST(URL, path_and_query)
{
  ...
  auto url = net::url::parse("file:///path/to#myfrag");
  ASSERT_EQ(std::string("file"), url.scheme);
  ASSERT_EQ(0, url.authority.length());
  ASSERT_EQ(std::string("/path/to"), url.path);
  ASSERT_EQ(0, url.query.size());
...
TEST(URL, query_and_fragment)
{
  ...
  auto url = net::url::parse("file://?some=value&simple&other=tRue#myfrag");
  ASSERT_EQ(std::string("file"), url.scheme);
  ASSERT_EQ(0, url.authority.length());
  ASSERT_EQ(0, url.path.length());
  ASSERT_EQ(3, url.query.size());
...
TEST(URL, IP_address)
{
  auto url = net::url::parse("TcP4://127.0.0.1:123");
...
TEST(URL, local)
{
  auto url = net::url::parse("local:///foo/bar");
...
TEST(URL, pipe)
{
  auto url = net::url::parse("pipe:///foo/bar");
...
{
  auto url = net::url::parse("pipe:///foo/bar?blocking=false");
...
TEST(URL, datagram)
{
  auto url = net::url::parse("pipe:///foo/bar?behaviour=datagram");
  ASSERT_EQ(1, url.query.size());
