...
struct ctor_test_data
{
  char const *        netspec;
  bool                throws;
  net::address_type  expected_proto;
  size_t              expected_mask;
  char const *        expected_network;
  char const *        expected_broadcast;
} ctor_tests[] = {
  // Garbage
  { "asddfs",         true,   net::AT_UNSPEC, size_t(-1), "", "", },

  // IPv4 hosts
  { "192.168.0.1",    true,   net::AT_UNSPEC, size_t(-1), "", "", },

  // IPv4 networks
  { "192.168.0.1/33", true,       net::AT_INET4,   size_t(-1), "", "", },
  { "192.168.0.1/32", false,      net::AT_INET4,   32, "192.168.0.1",     "192.168.0.1", },
  { "192.168.134.121/31", false,  net::AT_INET4,   31, "192.168.134.120", "192.168.134.121", },
  { "192.168.134.121/25", false,  net::AT_INET4,   25, "192.168.134.0",   "192.168.134.127", },
  { "192.168.134.121/24", false,  net::AT_INET4,   24, "192.168.134.0",   "192.168.134.255", },
  { "192.168.134.121/23", false,  net::AT_INET4,   23, "192.168.134.0",   "192.168.135.255", },
  { "192.168.134.121/17", false,  net::AT_INET4,   17, "192.168.128.0",   "192.168.255.255", },
  { "192.168.134.121/16", false,  net::AT_INET4,   16, "192.168.0.0",     "192.168.255.255", },
  { "192.168.134.121/15", false,  net::AT_INET4,   15, "192.168.0.0",     "192.169.255.255", },
  { "192.168.134.121/9",  false,  net::AT_INET4,    9, "192.128.0.0",     "192.255.255.255", },
  { "192.168.134.121/8",  false,  net::AT_INET4,    8, "192.0.0.0",       "192.255.255.255", },
  { "192.168.134.121/7",  false,  net::AT_INET4,    7, "192.0.0.0",       "193.255.255.255", },
  { "192.168.134.121/0",  true,   net::AT_INET4,   size_t(-1), "", "", },

  // IPv6 hosts
  { "2001:0db8:85a3:0000:0000:8a2e:0370:7334",    true,   net::AT_UNSPEC, size_t(-1), "", "", },
  { "2001:0db8:85a3:0:0:8a2e:0370:7334",          true,   net::AT_UNSPEC, size_t(-1), "", "", },
  { "2001:0db8:85a3::8a2e:0370:7334",             true,   net::AT_UNSPEC, size_t(-1), "", "", },

  // IPv6 networks
  { "2001:0db8:85a3:0000:0000:8a2e:0370:7334/22", false,  net::AT_INET6,  22, "2001:C00::", "2001:fff:ffff:ffff:ffff:ffff:ffff:ffff", },
  { "2001:0db8:85a3:0:0:8a2e:0370:7334/22",       false,  net::AT_INET6,  22, "2001:C00::", "2001:fff:ffff:ffff:ffff:ffff:ffff:ffff", },
  { "2001:0db8:85a3::8a2e:0370:7334/22",          false,  net::AT_INET6,  22, "2001:C00::", "2001:fff:ffff:ffff:ffff:ffff:ffff:ffff", },

  { "2001:0db8:85a3:0000:0000:8a2e:0370:7334/129",true,   net::AT_INET6,  size_t(-1), "", "", },
  { "2001:0db8:85a3::8a2e:0370:7334/0",           true,   net::AT_INET6,  size_t(-1), "", "", },
};
...
TEST_P(NetworkConstruction, construct)
{
  ...
  if (td.throws) {
    ASSERT_THROW(network n{td.netspec}, std::invalid_argument);
  }
  else {
...
TEST(Network, ipv4_allocation)
{
  ...
  ASSERT_THROW(auto addr = n.reserve_address(), std::out_of_range);
...
TEST(Network, ipv4_allocation_with_id)
{
  ...
  ASSERT_THROW(address2 = net.reserve_address(id1), std::out_of_range);
